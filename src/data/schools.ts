...
export const schools: SchoolData[] = [
  ...
  {id:17,name:'Concordian International School',short:'Concordian',flag:'\u{1F1FA}\u{1F1F8}',cur:'us',curL:'American (AP)',
    loc:'bangna',city:'bangkok',locL:'บางนา กม.8',lat:13.6380,lng:100.6500,
    tMin:400000,tMax:650000,ls:['visual','kinesthetic'],
    web:'https://www.concordian.ac.th',mq:'Concordian+International+School+Bangkok',
    efScore:7,efNote:'AP + STEM focus + individual pathway',phone:'+66 2 034 9000',
    parentFit:{authoritative:8,authoritarian:7,permissive:7,neglectful:6},
    track:{topUni:['US universities','Thai universities'],src:'concordian.ac.th'},
    desc:'American curriculum + STEM เด่น',
    pros:['STEM programme','American AP','แคมปัสใหม่'],tags:['ap','american','stem'],
    establishedYear:2001,usp:'American AP + STEM เด่น / แคมปัสใหม่ใหญ่',
    foreignPassportRatio:'~30%',chineseStudentRatio:'~15%',avgClassSize:20,
    teacherStudentRatio:'1:10',nativeEnglishTeachers:true,teacherAccent:'American',
    avgTeacherTenure:'3-5 ปี',parentPraise:['STEM programme ดี','แคมปัสใหม่สวย','ครูใส่ใจ'],
    shadow:'มี Learning Support Centre',youtime:'Homeroom advisory, Counselor',extra:'STEM lab, Robotics, กีฬา 20+ ชนิด, Swimming, Art'},
  ...
  {id:21,name:'Dulwich College International Bangkok',short:'Dulwich',flag:'\u{1F1EC}\u{1F1E7}',cur:'igcse',curL:'IGCSE + IB DP',
    loc:'sukhumvit',city:'bangkok',locL:'สุขุมวิท (คาดการณ์)',lat:13.7200,lng:100.5800,
    tMin:600000,tMax:900000,ls:['visual','readwrite'],
    web:'https://www.dulwich.org',mq:'Dulwich+College+International+Bangkok',
    efScore:8,efNote:'Dulwich brand = Academic + Creative Arts excellence',phone:'+66 2 118 2772',
    parentFit:{authoritative:9,authoritarian:8,permissive:7,neglectful:6},
    track:{note:'เปิดเร็วๆ นี้ — Dulwich brand จาก London, มี campus ใน Shanghai/Singapore/Beijing',src:'dulwich.org'},
    desc:'เปิดเร็วๆ นี้ — Premium British + IB',
    pros:['Dulwich London brand','IGCSE+IB Dual pathway','ศิลปะ+วิชาการ'],tags:['upcoming','igcse','ib','premium'],upcoming:true,
    establishedYear:2025,usp:'Dulwich College London 400+ ปี + IGCSE/IB Dual path + ศิลปะ',
    shadow:'คาดว่ามี SEN + EAL',youtime:'คาดว่า House System + Arts programme',extra:'คาดว่า Performing Arts, Music, Drama, Sports, DofE'},
  ...
  {id:23,name:'Middleton International School Bangkok',short:'Middleton',flag:'\u{1F1F8}\u{1F1EC}',cur:'ib',curL:'IB (PYP to DP)',
    loc:'ekkamai',city:'bangkok',locL:'เอกมัย (คาดการณ์)',lat:13.7260,lng:100.5850,
    tMin:450000,tMax:750000,ls:['visual','kinesthetic'],
    web:'https://www.middleton.edu.sg',mq:'Middleton+International+School+Bangkok',
    efScore:8,efNote:'Singapore quality + IB inquiry',
    parentFit:{authoritative:9,authoritarian:7,permissive:8,neglectful:6},
    track:{note:'จาก Singapore — เน้น Entrepreneurship + STEM',src:'middleton.edu.sg'},
    desc:'จาก Singapore — IB + Entrepreneurship',
    pros:['Singapore quality standard','IB Programme','STEM+Entrepreneurship'],tags:['upcoming','ib','singapore-brand'],upcoming:true,
    establishedYear:2025,usp:'Singapore quality + IB + Entrepreneurship',
    shadow:'คาดว่ามี SEN Support',youtime:'คาดว่า Entrepreneurship programme',extra:'คาดว่า STEM, Robotics, Business Club'},

  {id:24,name:'St. Mark\'s International School ศรีนครินทร์',short:'St. Mark\'s ศรีนครินทร์',flag:'\u{1F1EC}\u{1F1E7}',cur:'igcse',curL:'IGCSE + A-Level',
    loc:'srinakarin',city:'bangkok',locL:'ศรีนครินทร์',lat:13.6500,lng:100.6350,
    tMin:300000,tMax:550000,ls:['visual','readwrite'],
    web:'',mq:'St+Marks+International+School+Srinakarin',
    efScore:7,efNote:'British structured + community',
    parentFit:{authoritative:8,authoritarian:8,permissive:7,neglectful:6},
    track:{note:'ขยาย campus ใหม่ฝั่งศรีนครินทร์',src:''},
    desc:'ขยายจากสาขาเดิม — British ศรีนครินทร์',
    pros:['British curriculum','ทำเลศรีนครินทร์','ค่าเทอมเข้าถึงได้'],tags:['upcoming','igcse','east-bangkok'],upcoming:true,
    usp:'British IGCSE ฝั่งศรีนครินทร์ ค่าเทอมเข้าถึงได้',
    shadow:'คาดว่ามี',youtime:'คาดว่า Pastoral Care',extra:'กีฬา, ดนตรี, ศิลปะ'},
  ...
  {id:32,name:'โรงเรียนสาธิต มศว ประสานมิตร',short:'สาธิตประสานมิตร',flag:'\u{1F1F9}\u{1F1ED}',cur:'thai',curL:'ไทยชั้นนำ (สาธิต)',
    loc:'watthana',city:'bangkok',locL:'วัฒนา',lat:13.7453,lng:100.5602,
    tMin:15000,tMax:20000,ls:['visual','auditory','readwrite','kinesthetic'],
    efScore:9,parentFit:{authoritative:9,authoritarian:8,permissive:5,neglectful:3},
    track:{topUni:['จุฬาฯ','มหิดล','ธรรมศาสตร์']},
    tags:['thai_top','satit'],desc:'สาธิตชื่อดัง สังกัด มศว'},
